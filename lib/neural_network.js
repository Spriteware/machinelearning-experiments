...
Network.prototype.train = function(training_data, epochs, visualise) {
    ...
    worker.addEventListener("message", function(e) {
        ...
        // if (typeof callback !== "function")
            // throw new NetException("Network.train callback must be a function", {callback: callback});
        ...
        window.requestAnimationFrame(function() {
            ...
            var g, gel = output_errors.length, sum, std_deviation;
            
            // Compute standart deviation
            for (g = 0, sum = 0; g < gel; g++)
                sum += (output_errors[g] - output_errors_mean) * (output_errors[g] - output_errors_mean);
            ...
            for (g = 0; g < gel; g++) {
                ...
                if (output_errors[g] > output_errors_mean - std_deviation && output_errors[g] < output_errors_mean + std_deviation)
                    graph_ctx.lineTo(g, _CANVAS_GRAPH_HEIGHT - output_errors[g] / output_errors_mean * _CANVAS_GRAPH_HEIGHT * 0.2);

                // Graphically separate epochs
                if (g > 0 && g % training_size === 0) {
                    graph_ctx.save();
            ...
            text_output.innerHTML = "epoch #" + e.data.curr_epoch + " / output error mean: " + output_errors_mean;
        });
    });
